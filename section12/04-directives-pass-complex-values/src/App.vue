    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                ...
                <p v-local-highlight:background.delayed="'pink'">Adding binding, Argument and Modifier delay</p>
                <p v-local-highlight:background.delayed.blink="{mainColor: 'red', secondColor: 'green', delay: 500}">Adding binding, Argument and Multiple Modifiers delay and blink</p>
